...
public class Exercise4SolutionTest extends CalculatorAbstract {
    ...
    public void summation() throws Exception {
        ...
        assertEquals(result[2][0], 8, 0);
        assertEquals(result[2][1], 5, 0);
        assertEquals(result[2][2], 4, 0);
        assertEquals(result[2][3], 0, 0);
        assertEquals(result[3][0], 12, 0);
        assertEquals(result[3][1], 12, 0);
        assertEquals(result[3][2], 11, 0);
        assertEquals(result[3][3], 4, 0);
    }
}
